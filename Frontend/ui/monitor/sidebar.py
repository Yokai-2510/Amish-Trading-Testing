...
class MonitorSidebar(Ctk.CTkFrame):
    def __init__(self, parent, show_content_callback):
        ...
        Ctk.CTkLabel(self, text="Sets", font=("Arial", 20, "bold")).pack(pady=(20, 10))

        # Stocks Section
        Ctk.CTkLabel(self, text="Stocks", font=("Arial", 16)).pack(pady=(10, 15))
        for i in range(1, 5):
